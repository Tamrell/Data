...
for factorie in factories:
	...
	for sensor in sensors:
		...
		print('Methylosmolene',len(Methylosmolene),len(MethylosmoleneTS))
		...
		p1.line(MethylosmoleneTS,MethylosmoleneMean,color='orange')

		p2.circle(ChlorodinineTS,Chlorodinine)
		p2.line(ChlorodinineTS,ChlorodinineMean,color='orange')
